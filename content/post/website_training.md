...
-   [1. Create a site](/docs/getting-started/install/)
...
Draw diagrams on pages using the Markdown-like [Mermaid](/docs/content/writing-markdown-latex/#diagrams) syntax:
...
© 2016-2021 [George Cushen](https://georgecushen.com)
